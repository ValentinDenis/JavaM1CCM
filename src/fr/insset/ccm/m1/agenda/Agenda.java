 ...
 * Un agenda est une liste de tâches
 */
public class Agenda implements List<Tache>{
    ...
    public List<Tache> getTachesImportantes(int inImportance){
        List<Tache> resultat = new LinkedList<>();
        // Notation lambda
        taches.stream().filter((suivante) -> (suivante.getImportance() >= inImportance)).forEach((suivante) -> {
